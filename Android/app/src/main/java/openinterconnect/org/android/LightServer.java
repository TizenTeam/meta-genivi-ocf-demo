 ...
 * //-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
 */
package openinterconnect.org.android;
 ...
 */
public class LightServer implements OcPlatform.EntityHandler {
    ...
    public LightServer(String resourceUri, String name, boolean state, int power) {
